...
struct TreeOfMitsuri {
	...
	ll st[max_mitsurii*4] , lazy1[max_mitsurii*4] , lazy2[max_mitsurii*4] , lazy3[max_mitsurii*4] , sum[max_mitsurii*4] ; 
	...
	void down(int id,int l,int r) {
		if(lazy1[id]==0 and lazy2[id]==0) return ; 
		add(st[id] , (1ll*(r-l+1)*lazy1[id]+sum[id]*lazy2[id]) %mod_mitsurii ) ; 
		if(l!=r) {
